...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 24, 2024 at 10:20 PM
...
--
ALTER TABLE `messages`
  ADD CONSTRAINT `messages_ibfk_1` FOREIGN KEY (`profile1ID`) REFERENCES `friend` (`profile2ID`),
  ADD CONSTRAINT `messages_ibfk_2` FOREIGN KEY (`profile2ID`) REFERENCES `friend` (`profile1ID`);
